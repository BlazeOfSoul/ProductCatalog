...
import { ProductModelUpdateByUser } from '../models/product.model.user.update';
...
export class ProductService extends BaseDataService {
  ...
  public updateProductUser(product: ProductModelUpdateByUser) {
    return this.sendPutRequest(product, actionRoutes.updateProductsUser);
  }
