...
public class AuthService : IAuthService
{
    ...
    public async Task<ServiceResponse<SignUpUserRequest>> SignUp(SignUpUserRequest signUpUser)
    {
        ...
        if (!emalUnique.Success) return new ServiceResponse<SignUpUserRequest>(emalUnique);
        ...
        if (!identityResult.Succeeded) return new ServiceResponse<SignUpUserRequest>("Password badValidation");
